...
from vaes.models import ConvAutoEncoder
...
@register_pipeline("conv_ae")
class ConvAEPipeline(BasePipeline):
    ...
    def build_model(self) -> nn.Module:
        return ConvAutoEncoder(**self.cfg.model.params)
    ...
    def init_callbacks(self) -> list[Callback]:
        """Initialize training callbacks for convolutional AE training."""
