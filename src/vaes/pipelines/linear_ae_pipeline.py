...
from vaes.models import LinearAutoEncoder
...
@register_pipeline("linear_ae")
class LinearAEPipeline(BasePipeline):
    ...
    def build_model(self) -> nn.Module:
        return LinearAutoEncoder(**self.cfg.model.params)

    def training_step(self, batch: Any, batch_idx: int) -> Dict[str, torch.Tensor]:
        images, labels = batch
        z, x_hat = self.model(images)
    ...
    def init_callbacks(self) -> list[Callback]:
        """Initialize training callbacks for linear AE training."""
